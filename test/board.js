...
const Engine = require('../src/board.js')
...
describe('Board', function() {	
	...
	describe('#flipBoard()', function() {
		it('flips the board', function() {
			let flipped_board = new Board()
			flipped_board.parseFenToBoard("r1bqk1nr/pppp1ppp/2n5/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq ")
			flipped_board.flipBoard()

			assert.equal(flipped_board.bb, 15992005286099480479n)
		})
	})
	
	describe('#indicesFor', function() {
		let pieceBoards = board.pieceBoards
...
describe('BoardView', function() {
	...
	describe("#display()", function() {
		...
		it('correctly flips the board', function() {
			...
			assert.equal(new BoardView(flipped_board.pieceBoards).display(),  '11111001\n11110111\n00000100\n00101000\n00101000\n00100000\n11110111\n10111011')
		})
	})
